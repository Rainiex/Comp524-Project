...
/** 
  ...
  */
  ...
  static WifiMode GetDsssRate2Mbps ();
    ...
    static WifiMode GetDsssRate3Mbps ();
    static WifiMode GetDsssRate4Mbps ();
    static WifiMode GetDsssRate5Mbps ();
    static WifiMode GetDsssRate6Mbps ();
    static WifiMode GetDsssRate7Mbps ();
    static WifiMode GetDsssRate8Mbps ();
    static WifiMode GetDsssRate9Mbps ();
    static WifiMode GetDsssRate10Mbps ();
    static WifiMode GetDsssRate12Mbps ();
    static WifiMode GetDsssRate13Mbps ();
    static WifiMode GetDsssRate14Mbps ();
    static WifiMode GetDsssRate15Mbps ();
    static WifiMode GetDsssRate16Mbps ();
    static WifiMode GetDsssRate17Mbps ();
    static WifiMode GetDsssRate18Mbps ();
    static WifiMode GetDsssRate19Mbps ();
    static WifiMode GetDsssRate20Mbps ();
