...
YansWifiPhy::Configure80211b (void)
{
  ...
  m_deviceRateSet.push_back (WifiPhy::GetDsssRate2Mbps ());
    ...
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate3Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate4Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate5Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate6Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate7Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate8Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate9Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate10Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate12Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate13Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate14Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate15Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate16Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate17Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate18Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate19Mbps ());
    m_deviceRateSet.push_back (WifiPhy::GetDsssRate20Mbps ());
