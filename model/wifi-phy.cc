...
WifiPhy::GetDsssRate2Mbps ()
{
  ...
  return mode;
    ...
    WifiMode
    WifiPhy::GetDsssRate3Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate3Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 3000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate4Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate4Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 4000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate5Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate5Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 5000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate6Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate6Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 6000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate7Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate7Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 7000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate8Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate8Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 8000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate9Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate9Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 9000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate10Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate10Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 10000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate12Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate12Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 12000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate13Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate13Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 13000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate14Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate14Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 14000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate15Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate15Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 15000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate16Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate16Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 16000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate17Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate17Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 17000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate18Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate18Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 18000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate19Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate19Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 19000000,
                                         WIFI_CODE_RATE_UNDEFINED,
    ...
    WifiMode
    WifiPhy::GetDsssRate20Mbps ()
    {
        static WifiMode mode =
        WifiModeFactory::CreateWifiMode ("DsssRate20Mbps",
                                         WIFI_MOD_CLASS_DSSS,
                                         true,
                                         22000000, 20000000,
                                         WIFI_CODE_RATE_UNDEFINED,
...
public:
  Constructor ()
  {
    ...
    ns3::WifiPhy::GetDsssRate2Mbps ();
      ...
      ns3::WifiPhy::GetDsssRate3Mbps ();
      ns3::WifiPhy::GetDsssRate4Mbps ();
      ns3::WifiPhy::GetDsssRate5Mbps ();
      ns3::WifiPhy::GetDsssRate6Mbps ();
      ns3::WifiPhy::GetDsssRate7Mbps ();
      ns3::WifiPhy::GetDsssRate8Mbps ();
      ns3::WifiPhy::GetDsssRate9Mbps ();
      ns3::WifiPhy::GetDsssRate10Mbps ();
      ns3::WifiPhy::GetDsssRate12Mbps ();
      ns3::WifiPhy::GetDsssRate13Mbps ();
      ns3::WifiPhy::GetDsssRate14Mbps ();
      ns3::WifiPhy::GetDsssRate15Mbps ();
      ns3::WifiPhy::GetDsssRate16Mbps ();
      ns3::WifiPhy::GetDsssRate17Mbps ();
      ns3::WifiPhy::GetDsssRate18Mbps ();
      ns3::WifiPhy::GetDsssRate19Mbps ();
      ns3::WifiPhy::GetDsssRate20Mbps ();
